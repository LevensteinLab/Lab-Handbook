...
3. **Pull in existing slides.** If you've been making slides for lab meetings and 1-on-1 meetings (which I encourage — see the [meetings page](https://levensteinlab.github.io/Lab-Handbook/Policies/meetings/)), you'll have a library of semi-presentable figures to draw from.
