...
2. Start a VS Code Proxy from the Interactive Apps section.
    ...
    1. Configure the proxy according to your needs (e.g. time, memory, number of cores, and type of partition)

    2. Launch the session. It may take a few minutes depending on how busy the cluster is

    3. If it's your first time using the VS Code proxy, follow the instructions listed to configure your `~/.ssh/config` file
